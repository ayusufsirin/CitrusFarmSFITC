...
CURRENT_NCUTOFF = 0.4  # Example value, you will change this
CURRENT_THRESHOLD = 50  # Example value, you will change this
LIDAR_RANGE = 0  # Example value, you will change this
...
def synchronized_callback(
    ...
    mask_nan_vlp = cp.isnan(vlp_depth)
    mask_inf_vlp = cp.isinf(vlp_depth)
    # vlp_depth[mask_nan_vlp] = LIDAR_RANGE
    # vlp_depth[mask_inf_vlp] = LIDAR_RANGE
    # vlp_depth[mask_nan_vlp] = vlp_depth.mean()
    # vlp_depth[mask_inf_vlp] = vlp_depth.mean()
